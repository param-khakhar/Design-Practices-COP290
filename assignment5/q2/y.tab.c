...
{
  "$end", "error", "$undefined", "INTEGER", "OPR1", "OPR2", "NEWLINE",
  "EXIT", "$accept", "lines", "expr", YY_NULLPTR
};
#endif
...
yyreduce:
  ...
  switch (yyn)
    {
        case 3:
#line 53 "fix.y" /* yacc.c:1646  */
    {fprintf(yyout,"%s ",top());fprintf(yyout,"%d\n",topn());}
#line 1252 "y.tab.c" /* yacc.c:1646  */
    break;

  case 5:
#line 57 "fix.y" /* yacc.c:1646  */
    {compute((yyvsp[0].expr));}
#line 1258 "y.tab.c" /* yacc.c:1646  */
    break;

  case 6:
#line 58 "fix.y" /* yacc.c:1646  */
    {compute((yyvsp[0].expr));}
#line 1264 "y.tab.c" /* yacc.c:1646  */
    break;

  case 7:
#line 59 "fix.y" /* yacc.c:1646  */
    {push((yyvsp[0].expr)); pushn((yyvsp[0].expr));}
#line 1270 "y.tab.c" /* yacc.c:1646  */
    break;

  case 8:
#line 60 "fix.y" /* yacc.c:1646  */
    { exit(0);}
